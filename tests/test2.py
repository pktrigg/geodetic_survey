...
sys.path.append(str(Path(__file__).parent.parent / "src/geodetic_survey"))
import sbd
...
# from geodetic_survey import sbd
# from geodetic_survey import fileutils
# from geodetic_survey import r2sonicdecode
# from geodetic_survey import refraction
